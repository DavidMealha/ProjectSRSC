...
public class Utils extends UtilsBase {
	/**
	 * Criacao de uma chave para os seguintes algoritmos: AES (128) DES (56)
	 * DESede (168) HmacSHA1 HmacSHA256
	 * 
	 * @param bitLength
	 * @param random
	 * @return Chave AES
	 ...
	 * <p>
	 * IV composto por 4 bytes (numero de emensagem) 4 bytes de random e um
	 * contador de 8 bytes.
	 * 
	 * @param messageNumber
	 *            - Numero da mensagem
	 * @param random
	 *            - source ou seed para random
	 ...
	 * 
	 * @param bytes
	 *            array contendo os caracteres
	 * @param length
	 *            N. de bytes a processar
	 ...
	 * 
	 * @param bytes
	 *            - Array que contem os caracteres
	...
	/**
	 * Converte a string passada num array de bytes a partir dos 8 bits de cada
	 * caracter contido no array
	 * 
	 * @param string
	 *            - String a converter
