...
public class FileGenerator {
	...
	public static void main(String[] args)
		...
		if (args.length != 9) {
			...
			System.out.println(
					"args : filename/host password PBEAlgorithm SaltSize PBECounter CiphersuiteAlgorithm KeySize MacAlgorithm MacKeySize");
			System.out.println(
					"e.g  : 224.10.10.10 password PBEWithSHAAnd3KeyTripleDES 8 1024 AES/CBC/PKCS5Padding 256 DES 64");
		} else {
			...
			createCrypto(LOGFILESDIR + filename + CRYPTOEXTENSION, pbe, password, CiphersuiteAlgorithm,
					CiphersuiteKeySize, MacAlgorithm, MacKeySize);
